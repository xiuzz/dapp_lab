...
const NFTDetail = () => {
  ...
  const handleBuyClick = async () => {
    if (allowance === 0) {
      await approve("0x322813Fd9A801c5507c9de605d63CEA4f2CE6c44", "10000000000000000000000");
    } else {
      await buy(tokenId);
    }
  };
  ...
  useEffect(() => {
    const getInfo = async () => {
      ...
      const allowance = await getAllowance(address, "0x322813Fd9A801c5507c9de605d63CEA4f2CE6c44");
